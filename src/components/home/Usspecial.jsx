    ...
    <section className='mt-5'>
        <div className='flex flex-col gap-1 justify-center items-center'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 p-4 lg:p-10 xl:px-[86px]'>
                <div className='w-full h-[220px] md:h-[359px] bg-[#C7EEFB] flex flex-row rounded-4xl gap-5 border-white border-1 relative'>
                ...
                <div className='w-full h-[220px] md:h-[359px] bg-[#E1DBF1] flex flex-row rounded-4xl gap-5 border-white border-1 relative'>
                ...
                <div className='w-full h-[220px] md:h-[359px] bg-[#FBF7C7] flex flex-row rounded-4xl gap-5 border-white border-1 relative'>
                ...
                <div className='w-full h-[220px] md:h-[359px] bg-[#C7FBE9] flex flex-row rounded-4xl gap-5 border-white border-1 relative'>
