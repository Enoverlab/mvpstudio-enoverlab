    ...
    <section className='mt-5'>
        <div className='flex flex-col gap-1 justify-center items-center'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 p-4 lg:p-10 xl:px-[86px]'>
                ...
                <div className='w-full h-[220px] md:h-[359px] bg-[#dbd6e6] flex flex-row rounded-4xl gap-5 border-white border-1 relative'>
                ...
                <div className='w-full h-[220px] md:h-[359px] bg-[#ece8bf] flex flex-row rounded-4xl gap-5 border-white border-1 relative'>
                ...
                <div className='w-full h-[220px] md:h-[359px] bg-[#a0e0cb] flex flex-row rounded-4xl gap-5 border-white border-1 relative'>
